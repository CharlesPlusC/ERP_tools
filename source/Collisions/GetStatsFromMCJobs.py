...
def process_file(file_path, output_file):
    ...
    if tca and dca:
        try:
            ...
            print("Failed to write TCA, DCA to {}: {}".format(output_file, e))
    else:
        print("No valid TCA or DCA extracted for file: {}".format(file_path))
...
def process_spacecraft(sat_name, fm_num, base_directory):
    ...
    if not distance_files:
        print("No distance files found for {} FM{}".format(sat_name, fm_num))
        return
    ...
    try:
        ...
        print("Failed to create or write to output file {}: {}".format(output_file_path, e))
        return

    print("Processing files for {} FM{}".format(sat_name, fm_num))
...
def main(base_directory="/home/zcesccc/Scratch/MCCollisions", specific_sat_name=None):
    ...
    for sat_name in sat_names:
        ...
        if not fm_dirs:
            print("No force model directories found for {}".format(sat_name))
