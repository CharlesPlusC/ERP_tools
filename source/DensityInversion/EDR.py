...
def calculate_orbital_energy(sat_name, force_model_config, gravity_degree=90, gravity_order=90, other_accs=False):
    ...
    print(f"last time: {ephemeris_df['UTC'].iloc[-1]}")
