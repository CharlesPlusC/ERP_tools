...
def main():
    ...
    for sat_name in sat_names_to_test:
        ...
        fig.tight_layout()
        plt.title(f"{sat_name}: Effective Density and r")
        plt.show()
        ...
        force_model_config = {'120x120gravity': True, '3BP': True,'solid_tides': True, 'ocean_tides': True, 'knocke_erp': True, 'relativity': True}
