...
def propagate_state(start_date, end_date, initial_state_vector, cr, cd, cross_section, mass, boxwing, ephem=False,dt=None, **config_flags):
    ...
    end_date : datetime.datetime
        The end date of the propagation.
    ...
    cd : float
        Drag coefficient.
    cross_section : float
        Cross-sectional area of the spacecraft.
    mass : float
        Mass of the spacecraft.
    boxwing : bool
        Whether to use the boxwing model for the spacecraft. Only available for spacecraft in misc/boxwing_configs.json
    ephem : bool, optional
        Whether to return a 60s ephemeris, by default False

    Returns
    -------
    list or org.orekit.propagation.Ephemeris
